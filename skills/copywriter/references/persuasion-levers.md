...
Read for acquisition levers, human desires, hooks, and rewrite examples. Follow the scope and safety contract in the skill entry point.

## Pull a Psychological Lever (Acquisition and Conversion)
...
Utility microcopy follows the in-app craft branch: communicate the action and
consequences accurately. Acquisition copy can use emotional pull grounded in real
product value. Do not apply this lever requirement to routine controls or errors.
