# The 5-Step Persuasion Skeleton

Long-form narrative template for copy that needs a full arc: landing pages,
...
```
1. HOOK      → Name the exact moment they're already in
2. AGITATE   → Make the cost concrete, physical, felt
3. EMPATHIZE → Show you've lived it too
4. SOLVE     → Name the specific mechanism
5. PAYOFF    → Paint the after-state (don't recap)
```

Every beat must earn the next scroll. Skip a beat and the copy reads as a pitch
from a stranger instead of help from someone who understands.
...
they're already living: the frustration, the failed attempt, the thing they've
been telling themselves. Wrong awareness stage makes even a clever line read as
confusing, irrelevant, or condescending.

**Awareness quick-pick:**

| Stage | Reader state | Hook angle |
| --- | --- | --- |
| Unaware | Doesn't know they have the problem | Symptom they recognize ("Why you're always tired by 3pm") |
| Problem-aware | Knows the pain, not the category | Name the pain precisely ("You've tried 4 budget apps and still don't know where the money went") |
| Solution-aware | Knows solutions exist, hasn't picked | Differentiate or debunk ("Most workout apps track reps. None tell you when to add weight.") |
| Product-aware | Knows you, hasn't acted | Specific proof or objection ("10,000 lifters log every set in two taps") |
| Most aware | Ready to buy | Offer, urgency, or final proof |

**Fails when:** Topic announcement, product description, or clever wordplay that
doesn't match where the reader actually is. See Hook Gut Check in `SKILL.md`.

**Examples:**

- Weak: "Introducing the smartest workout tracker."
- Strong (problem-aware): "You hit the gym four days a week and still look the same."
- Strong (solution-aware): "Tracking sets isn't the problem. Knowing when to add weight is."
...
- Weak: "Poor sleep affects your productivity."
- Strong: "You wake up at 5:47, hit snooze twice, and by 10am you're on your
  third coffee wondering why yesterday felt like a blur."

Use numbers, time, place, and body sensation when they're real. One vivid
detail beats three vague adjectives.

**Fails when:** Vague problems feel skippable. "Struggling with X" is a label,
not agitation. Restating the hook in different words adds nothing.

**Compress for short formats:** One sentence of sensory cost is enough for a
caption hook line. Save the full scene for long captions and landing body copy.
...
dumb, lazy, or alone. You've been in the same loop, or you've watched enough
people in it to know why the obvious fixes fail.

**Patterns that work:**

- "It's not because you're not trying."
- "Every app promises this. None fix the part that actually breaks."
...
"we fixed the trailing-slash bug killing 30 pages." Not "smart tracking" but
"log every set in two taps and we'll tell you exactly when to add weight."

**Include when possible:**

- The named mechanism (what actually changes)
- One concrete proof point (number, time saved, before/after)
- Why this approach works when others didn't (only if true)

**Fails when:** Feature lists, category claims, or benefits without a mechanism.
...
look like? What do they stop worrying about? What do they tell a friend?

**Fails when:** Summarizing what you just said. "So in summary, our app helps
you track, plan, and achieve your goals" kills momentum. Feature recaps at the
end are the most common failure mode.

**Write payoff as future-present:**
...
## Map Beats to Formats

| Format | HOOK | AGITATE | EMPATHIZE | SOLVE | PAYOFF |
| --- | --- | --- | --- | --- | --- |
| Landing page | Hero headline | Hero subhead or first body block | Short "we get it" line or founder note | Feature sections (mechanism each) | Final CTA section + after-state line |
| App Store description | Opening 1–2 lines | Next paragraph | Optional 1 line | Body bullets / mechanism | Closing line before CTA |
| Long IG caption | Line 1 | Lines 2–4 | 1 sentence | Body (numbered if promised) | Last paragraph before CTA |
| Slideshow (5–8 slides) | Slide 1 | Slide 2 | Slide 3 | Slides 4–6 | Final slide + CTA |
...
## Worked Example (fitness app, long caption)

**HOOK:** You've been going to the gym 4 days a week for months. You look the
same.

**AGITATE:** Same weights. Same exercises. You leave sore but you couldn't tell
