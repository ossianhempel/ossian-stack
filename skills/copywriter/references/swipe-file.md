...
patterns from here; translate into the product's voice and specifics. Do
not copy verbatim unless Ossian asks for a direct adaptation.

All inspiration lives in this repo. No external apps or vaults.
...
When Ossian pastes examples in chat, append them here in the same format
(unless he says "draft only, don't save").

## Hooks & openers

<!-- Paste hook overlays, first lines, subject lines, App Store openers -->

## App Store

<!-- Screenshot headlines, subtitles, description openers -->
...
>
> JarvX learns what your audience actually rewards, then helps you double down on it, turning your posts into real X payouts, not guesswork.
...
<!-- Buttons, empty states, paywall lines, onboarding promises -->

## Social captions & stacks

<!-- IG/TikTok captions, slideshow slide text, carousel hooks -->

## Profiles & bios

<!-- Display names, bios, link-in-bio lines -->
...
| --- | --- | --- |
| ROI hero | `[Category] that pays for itself` + learns [signal] → act on it → [concrete win] not [vague alternative] | JarvX landing |
| Feature triplet | `[Everything you have], ranked by [metrics]. [Hidden insight] becomes [clear]. No more [painful status quo].` | JarvX landing |
