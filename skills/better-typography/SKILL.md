...
description: "Web typography: fonts, variable fonts/OpenType, type scales, heading hierarchy, spacing, wrapping, truncation, underlines, selection, placeholders, carets, tabular numbers, text contrast, and iOS input zoom. Use when building or reviewing frontend typography."
---
