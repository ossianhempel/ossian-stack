...
Example:
"We're sorry the syncing issues are affecting your experience. Our team
is actively working on a fix for the next update. In the meantime, please
try logging out and back in, which resolves this for most users. If issues
persist, email us at support@app.com and we'll prioritize your case."
```
...
Example:
"Thank you for the kind words! We're thrilled the reminder feature helps
you stay organized. If you're enjoying the app, we'd love if you'd share
