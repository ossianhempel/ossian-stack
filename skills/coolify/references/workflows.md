...
Read for resource discovery, deployment, env changes, databases, services, backups, or infrastructure recipes. Follow the scope and safety contract in the skill entry point.
