...
- Confidence: candidate
- Skip when: Bugbot flags an export, component, helper, or file as unused, and the bundled watcher's stack view, upper-stack diffs, or GitHub PR base/head context shows it is used by a later PR in the stack.
