...
When work starts from an existing review draft, preserve its `SUBMISSION_ID` in the handoff to [release flow](release-flow.md). The release flow must inspect and reuse that draft rather than create another submission.
...
Inspect the completed version and return its ID to [release flow](release-flow.md):
...
Do not add the version to a review submission from this skill. Hand `SUBSCRIPTION_VERSION_ID` to the multi-item workflow in [release flow](release-flow.md).
...
Inspect the group version and return its ID to [release flow](release-flow.md):
...
Do not add the version to a review submission from this skill. Hand `GROUP_VERSION_ID` to the multi-item workflow in [release flow](release-flow.md).
...
Inspect the version and return its ID to [release flow](release-flow.md):
...
Do not add the version to a review submission from this skill. Hand `IAP_VERSION_ID` to the multi-item workflow in [release flow](release-flow.md).
