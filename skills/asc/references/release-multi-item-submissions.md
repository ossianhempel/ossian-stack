...
- Use [submission health](submission-health.md) to repair missing IAP, subscription, or subscription-group versions.
...
If inspection shows an existing active or completed submission instead of the draft being assembled, stop and diagnose through [submission health](submission-health.md) rather than creating another submission.
