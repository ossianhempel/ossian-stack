...
[ad hoc distribution](ad-hoc-distribution.md) skill instead of assembling those stages manually.
...
- Verify profiles with the [signing setup](signing-setup.md) skill.
...
- For submission readiness, use [submission health](submission-health.md).
