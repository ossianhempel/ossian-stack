...
Use [screenshot resize](screenshot-resize.md) or `ios-marketing-capture` for screenshot production. Return here after the files pass validation and are uploaded.
