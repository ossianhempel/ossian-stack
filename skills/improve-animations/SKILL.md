...
description: "Read-only audit of a codebase's animation and motion code, with prioritized findings and implementation plans. Use for 'improve the animations', 'audit the motion', 'make this app feel better', or a roadmap of animation fixes. Do not apply source changes."
---
