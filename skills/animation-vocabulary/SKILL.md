...
description: "Name a web animation or motion effect from a vague description, such as pop in or iOS rubber-banding. Use for 'what's it called when...' or when the user needs the exact motion term for a designer or AI prompt. Naming only; do not design or build it."
---
